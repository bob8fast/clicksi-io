// app/(management)/brand-management/commission/[ruleId]/page.tsx - Commission Rule Detail Page
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  // In a real implementation, you might fetch the rule name for the title
  return {
    title: `Commission Rule ${ruleId} - Brand Portal`,
